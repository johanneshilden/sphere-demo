  ...
  getNodeContent: function () {
    ...
    if (!this.props.externalIsLoading || this.props.enableInfiniteScroll) {
      ...
      var nodes = nodeData.map(function (row, index) {
        ...
        return React.createElement(GridRowContainer, { rowDecorator: that.props.rowDecorator, useGriddleStyles: that.props.useGriddleStyles, isSubGriddle: that.props.isSubGriddle,
